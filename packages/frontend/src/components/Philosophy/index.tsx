    ...
    <Grid container>
      ...
      <Grid item md={12}>
        <Typography variant="h5" style={{ padding: '50px' }}>
          ...
          with their dogs. These standards come from years of feeling fear, shame, and confusion in
          my interactions with animals, interactions that were based on repeating and mimicking what
          I was taught and cognitive dissonance that eventually became impossible to maintain. I
          reached a point in my personal life that changed everything, and set me up to be
          teachable, and ready to accept that I had made mistakes. While I can’t go back and undo my
          past, I can be rigorously accountable and remember each of those animals in every
          interaction I have now.
        </Typography>
      </Grid>
      <Grid
        item
      ...
      >
        ...
        >
          <Typography variant="h5" style={{ fontWeight: 600 }}>
            ...
            understanding of facts about this industry, and facts about animal behavioral sciences.
          </Typography>
        </Grid>
      </Grid>
      <Grid item md={12}>
        <Typography variant="h5" style={{ padding: '50px 50px 0 50px' }}>
          ...
          vital part of the process, learning about the dog as a whole, or the science of behavioral
          modification, is not included in the curriculum. Taking a dog away from a handler or owner
          to &quot;train&quot; it, is NOT the same as being able to teach a handler or owner how to
          build a relationship with their dog.
        </Typography>
        <Typography variant="h5" style={{ padding: '50px 50px 0 50px' }}>
          Most training &quot;certifications&quot; require a subscription to an ideology, as defined
          by the creator of the ideology, regardless of whether it contradicts psychology, or the
          science of behavior. Gaps in scientifically accurate curriculum are filled with
        ...
        <Typography variant="h5" style={{ padding: '50px 50px 0 50px' }}>
          ...
          vindicating personal feelings and attitudes, without any actual competency substantiated.
          The rhetoric is that &quot;everyone has their own style&quot; of training. Certainly, we
          all have different personalities and abilities. But in this industry, a person can create
          their own truth, and sell it, with zero consequences for the destruction they may leave in
          their wake, and simply call it their &quot;style&quot;...
        </Typography>
        <Typography variant="h5" style={{ padding: '50px' }}>
          Because this is a results based industry, and it often doesn&apos;t matter what is done to
      ...
      <Grid item md={12}>
        <Typography variant="h5" style={{ padding: '50px 50px 0 50px' }}>
          Every time she would bark, lunge, or even look at another animal, she would get cranked on
          and yelled at. She got to where we could walk or run past anything, reaction-free, within
          a very short amount of time. Her owner only had to pop the leash to get the same results.
          People who knew the dog raved about how amazing I was, and how they never thought the dog
          would be able to behave like that. Well, the owner was not willing to handle her dog the
          way I did, and after a while, the behavior returned. Of course I blamed her for not doing
          what needed to be done, and I always justified my behavior with something like &quot;
        ...
        <Typography variant="h5" style={{ padding: '50px' }}>
          ...
          before. Symposiums, 72-hour courses, jobs based on what tools I used, and pats on the back
          for not being afraid to &quot;handle&quot; (roughly) certain breeds, were the norm.
        </Typography>
      </Grid>
      <Grid
        item
      ...
      <Grid item md={12}>
        <Typography variant="h5" style={{ padding: '50px 50px 0 50px' }}>
          There are a TON of job openings out there for &quot;positive only&quot; trainers, and what
          is important to note is: the term &quot;positive only&quot; is a misuse of operant
        ...
        <Typography variant="h5" style={{ padding: '50px 50px 0 50px' }}>
          I have removed the names of the following companies and individuals, as the point of this
          is not to point out individuals, but rather an industry-wide problem.
        </Typography>
      </Grid>
      ...
      <Grid item md={12}>
        <Typography variant="h5" style={{ padding: '50px' }}>
          ...
          psychologists. This is information that is pulled from the genius works of history&apos;s
          giants, like B.F. Skinner, Pavlov, Dmitri Belyaev, Lyudmila Trut, and Clarence
          Pfaffenberger (to name a few), and how it relates to LIMA as defined by Steven Lindsay.
          Obedience is broken down into phases that reflect an understanding of the above, and how
          it applies to our goals for our personal or working dogs.
        </Typography>
      </Grid>
      <Grid
        item
      ...
      <Grid item md={12}>
        <Typography variant="h5" style={{ padding: '50px 50px 0 50px' }}>
          ...
          about canine behavior and psychology, or to be truthful and ethical in their practices or
          marketing.
        </Typography>
      </Grid>
      <Grid item md={12}>
