...
import HeroImg from '../../assets/images/static/erns-58.jpeg';
      ...
      <Grid container>
        ...
        <Grid item md={12} style={{ padding: '50px' }}>
          <Typography variant="h5" style={{ fontWeight: 600, paddingBottom: '25px' }}>
            ...
            coaching service, dedicated to helping you build the relationship that you want, with
            your dog.
          </Typography>
          <Typography variant="h5" style={{ paddingBottom: '25px' }}>
            ...
            available. We will progress through the training at you and your dog’s pace. Together,
            we will take the training as far as you would like to go.
          </Typography>
              ...
              <Collapse in={showGroupClasses} timeout="auto" unmountOnExit>
                <List>
                  ...
                  <ListItem style={{ paddingLeft: '50px' }}>
                    ...
                    swimming lessons and fitness with Fido. These classes are uplifting, fun, and
        ...
        <Grid item md={12}>
          <Typography variant="h5" style={{ padding: '50px', fontWeight: 550 }}>
            If you have an aggressive dog and are out of the area, please take advantage of my
            online aggression consultations, support, and online training. There is hope! I am here
            for you!
          </Typography>
        </Grid>
      </Grid>
